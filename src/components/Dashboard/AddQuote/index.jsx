...
const AddQuote = () => {
  ...
  const fetchCustomers = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/list_users?query=${searchQuery}`, {
        method: "GET",
        headers: {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      const uploadResponse = await fetch('${process.env.REACT_APP_API_URL}/upload_file', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer: ${token}`,
        },
      ...
      const updateResponse = await fetch('${process.env.REACT_APP_API_URL}/create_quotation', {
        method: 'POST',
        headers: {
