...
const Dashboard = () => {
  ...
  const fetchQuotes = async () => {
    try {
      const response = await fetch("${process.env.REACT_APP_API_URL}/list_quotations", {
        method: "GET",
        headers: {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      const updateResponse = await fetch('${process.env.REACT_APP_API_URL}/update_quotation', {
        method: 'PUT',
        headers: {
